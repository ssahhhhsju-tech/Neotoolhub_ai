...
export function TextGenerator() {
  ...
  const { isLoading, result, error, errorCode, generate, retry, reset } = useAIGeneration('text')
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <h3 style={styles.title}>AI Text Generator</h3>
      </div>
      <p style={styles.description}>Generate intelligent text responses powered by AI.</p>
